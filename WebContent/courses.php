...
<html>
	...
	<div id="fh5co-project-coursePage">
		<div class="container-fluid proj-bottom">
			<div class="row search-area">
				<div class="col-md-3 more-filter" >
					<h4>Filters</h4>
					<hr>
				</div>
				<div class="col-md-9 course-wrapper">
					...
					<div class="col-md-12 course-content">
						<h3>Course List <span class="dot"></span><span>204 Courses found.</span></h3>
						<br>
						<div class="row cList">
							<div class="col-md-10 col-xs-8">
								<h4>Course Name</h4>
								<span>Duration :</span><span>4 Years</span>
							</div>
